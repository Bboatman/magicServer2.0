...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CARDINSTANCE_LIST actions', async () => {
    ...
    it('dispatches FETCH_CARDINSTANCE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CARDINSTANCE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CARDINSTANCE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CARDINSTANCE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CARDINSTANCE actions', async () => {
      const expectedActions = [
        {
